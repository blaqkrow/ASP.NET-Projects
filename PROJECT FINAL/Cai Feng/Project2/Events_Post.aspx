<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_2.master" AutoEventWireup="true" CodeFile="Events_Post.aspx.cs" Inherits="Events_Post" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
            <div class="post">
                    ...
                    <img src="images/captains2.jpg" alt="Image 01" class="image_frame image_fl" />
              ...
              <div id="comment_section">
                ...
                <div id="comment_form">
                   ...
                   <form action="#" method="get">
                        ...
                        <asp:Button ID="btn_Comment" runat="server" Text="Comment" onclick="btn_Comment_Click" />
                    </form>
