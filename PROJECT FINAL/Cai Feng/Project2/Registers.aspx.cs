...
public partial class Registers : System.Web.UI.Page
{
    ...
    protected void btnRegister_Click(object sender, EventArgs e)
    {
        ...
        if (!(inUse) && filled)
        {
            ...
            mySQL = "INSERT INTO [User](User_ID,User_UName,User_FistName,User_LastName,User_Password,User_Birthday,User_Email,Type_ID) VALUES('" + userid + "','" + txtUName.Text.Trim() + "','" + txtFName.Text.Trim() + "','" + txtLName.Text.Trim() + "','" + txtPWord.Text.Trim() + "','" + Convert.ToDateTime(txtBirthday.Text) + "','" + txtEmail.Text.Trim() + "','" + 1 + "')";
