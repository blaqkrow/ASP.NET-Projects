...
public partial class Moderator_Profile : System.Web.UI.Page
{
    int userID;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataReader dr2;
        SqlCommand cmdUsers2 = new SqlCommand("select * from [Payment] where User_ID = '" + Convert.ToString(userID) + "'", conn);
    ...
    {
        Response.Redirect("Moderator_EditProfile.aspx");
    }
}