...
public partial class Member_SentMessage : System.Web.UI.Page
{
    string firstColumn;
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        Response.Redirect("Member_SentMessage.aspx");
    }
    ...
    protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        Response.Redirect("Member_Reply.aspx"); //go to reply page
