...
public partial class Admin_Events : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        mySQL = "DELETE FROM Event WHERE Event_ID = " + Convert.ToInt32(Session["Selected"]) + " AND Event_CreateBy = '"+Session["UName"]+"'";
    ...
    {
        Response.Redirect("Admin_EditEvent.aspx");
    }
    ...
    {
        Response.Redirect("Admin_AddEvent.aspx");
    }
}