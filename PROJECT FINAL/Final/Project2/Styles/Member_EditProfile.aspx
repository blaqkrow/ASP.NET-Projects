<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_4.master" AutoEventWireup="true" CodeFile="Member_EditProfile.aspx.cs" Inherits="Styles_Member_EditProfile" %>
            ...
            <td class="style1">
                <table class="style1">
                    <tr>
                        ...
                        <td class="style3"><asp:Button ID="btn_Confirm" runat="server" Text="Confirm" /></td>                
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td class="style1">
                <table class="style1">
                    <tr>
                        ...
                        <td class="style3"><asp:RadioButtonList ID="RadioButtonList1" runat="server"></asp:RadioButtonList></td>
                    </tr>
                </table>
            </td>
        </tr>
