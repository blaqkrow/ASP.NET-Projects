<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_2.master" AutoEventWireup="true" CodeFile="EventsPost.aspx.cs" Inherits="EventsPost" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="post">
                    <h2><asp:Label ID="lbl_tittle" runat="server" Text=""></asp:Label>
