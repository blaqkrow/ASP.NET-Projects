...
public partial class Admin_AddEvent : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        mySQL = "UPDATE Event SET Event_Name='" + txtEName.Text.Trim() + "',Event_Description='" + txtDescription.Text.Trim() + "',Event_Date='" + Calendar2.SelectedDate + "' where Event_ID = " + Convert.ToInt32(Session["Selected"]) + "";
