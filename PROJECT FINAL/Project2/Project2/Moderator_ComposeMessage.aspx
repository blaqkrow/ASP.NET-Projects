<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_6.master" AutoEventWireup="true" CodeFile="Moderator_ComposeMessage.aspx.cs" Inherits="Moderator_ComposeMessage" %>
                ...
                <div class="cleaner h20"></div>
                   <div id="contact_form">
                	<form method="post" name="contact" action="#">
                        ...
                        <asp:Button type="reset" ID="btn_reset" runat="server" Text="Reset" class="submit_btn float_l" />                    
                    </form>
                </div>
